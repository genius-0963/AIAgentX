...
class TestSensitiveDataClassifier:
    ...
    @pytest.mark.asyncio
    async def test_classify_no_sensitive_data(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_classify_phone(self) -> None:
        classifier = SensitiveDataClassifier()
    ...
    @pytest.mark.asyncio
    async def test_classify_ssn(self) -> None:
        classifier = SensitiveDataClassifier()
    ...
    @pytest.mark.asyncio
    async def test_classify_credit_card(self) -> None:
        classifier = SensitiveDataClassifier()
    ...
    @pytest.mark.asyncio
    async def test_classify_api_key(self) -> None:
        classifier = SensitiveDataClassifier()
    ...
    @pytest.mark.asyncio
    async def test_classify_password(self) -> None:
        classifier = SensitiveDataClassifier()
    ...
    @pytest.mark.asyncio
    async def test_classify_ip_address(self) -> None:
        classifier = SensitiveDataClassifier()
    ...
    @pytest.mark.asyncio
    async def test_classify_multiple_types(self) -> None:
        classifier = SensitiveDataClassifier()
